...
//}
//
//var workTimes = make(map[int]workTime)
//var tid = 1
//
//
...
//введення дня тижня
//вибір
//введення часу початку роботи
//або
//введення часу завершення роботи
//
//необхідний алгоритм вибір заних з таблиці
//групування за датою
//
//Структура виводу інформації
//
//Користувач mo tu we th fr sa su sum
//
//
////
//// if 0 = 0
//// if no end time  - in progress
//
//
//
//
